...
I currently use 1xChatGPT-Plus and 2xClaude-Pro, roughly amounting to 65 euros per month.
...
- [agentic-mv](scripts/agentic-mv.py) -> `mv` that persists your sessions and settings.
